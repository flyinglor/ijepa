...
class MaskCollator(object):
    ...
    def __init__(
        ...
        self.height, self.width, self.depth = input_size[0] // patch_size, input_size[1] // patch_size, input_size[2] // patch_size
    ...
    def _sample_block_mask(self, b_size, acceptable_regions=None):
        """
        Generates a mask for a 3D block within a 3D grid.

        :param b_size: Tuple (h, w, d) representing the height, width, and depth of the block.
        :param acceptable_regions: List of tensors containing indices of regions to keep, shaped as [depth, height, width].
