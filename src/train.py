...
from src.datasets.custom_image_dataset import make_adni, make_ukb
...
def main(args, resume_preempt=False):
    ...
    if dataset == 'adni':
        ##TODO: 3d implementation of masking 
        ...
        _, validation_loader, validation_sampler = make_adni(
            transform=transform,
            batch_size=batch_size,
            collator=mask_collator,
            pin_mem=pin_mem,
        ...
        #create adni dataloader
        _, unsupervised_loader, unsupervised_sampler = make_ukb(
            transform=transform,
            batch_size=batch_size,
            collator=mask_collator,
            pin_mem=pin_mem,
        ...
        _, validation_loader, validation_sampler = make_ukb(
            transform=transform,
            batch_size=batch_size,
            collator=mask_collator,
            pin_mem=pin_mem,
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        ##TODO: add validation and model saving(best and last)
        #iterate over validation dataloader
        for itr, (udata, masks_enc, masks_pred) in enumerate(validation_loader):
        ...
        if val_loss_meter.avg < best_validation_loss:
